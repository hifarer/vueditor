...
/***/ function(module, exports, __webpack_require__) {
	...
	var _design = __webpack_require__(47);
	...
	exports.default = {
	  data: function data() {
	    return {
	      ...
	      defaultConfig: ['removeFormat', 'undo', '|', 'elements', 'fontName', 'fontSize', 'foreColor', 'backColor', 'divider', 'bold', 'italic', 'underline', 'strikeThrough', 'divider', 'subscript', 'superscript', 'divider', 'justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull', '|', 'indent', 'outdent', '|', 'table1', '|', 'view'],
	      customConfig: _config.toolbarConfig
	    };
	  },
	  ...
	  methods: {
	    toggle: function toggle() {
	      if (!this.toolBtns[this.param.colorType].disabled) {
	        var obj = this.$el.nextElementSibling;
...
/***/ function(module, exports) {
	...
	var toolbarConfig = exports.toolbarConfig = ['removeFormat', 'undo', '|', 'elements', 'fontName', 'fontSize', 'foreColor', 'backColor', 'divider', 'bold', 'italic', 'underline', 'strikeThrough', 'divider', 'subscript', 'superscript', 'divider', 'justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull', '|', 'indent', 'outdent', '|', 'table1', '|', 'view'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toolBtns = {};
	_config.toolbarConfig.push('redo');
	_config.toolbarConfig.forEach(function (name) {
