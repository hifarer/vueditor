...
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_60__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _states = __webpack_require__(21);
	...
	function mixinConfig(opts) {
	  ...
	  var lang = config.lang || _lang2.default;
	  var list = ['fontName', 'fontSize', 'format', 'foreColor', 'backColor', 'vetable', 'undo', 'velink', 'emoji', 'picture', 'sourceCode', 'markdown', 'fullScreen'];
	  for (var name in config.plugins) {
	    var data = config.plugins[name].data();
	    list.push(name);
	    // lang[name] = data.lang;
	    _app2.default.components[name] = config.plugins[name];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _design = __webpack_require__(36);
	...
	var _fontname = __webpack_require__(37);
	...
	var _sourcecode = __webpack_require__(44);
	...
	var _markdown = __webpack_require__(42);

	var _markdown2 = _interopRequireDefault(_markdown);

	var _fullscreen = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: Object.assign({}, (0, _vuex.mapActions)(['updateContent', 'updateButtonStates', 'updatePopupDisplay', 'exec']), {
	    ...
	    selectionChange: function selectionChange() {
	      ...
	      this.iframeDoc.addEventListener('selectionchange', function () {
	        ...
	        timer = setTimeout(function () {
	          _this2.view == 'design' && _this2.updateStates();
	        }, 300);
	      }.bind(this), false);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    showPopup: function showPopup(name, rect) {
	      var display = this.states[name].showPopup.display;
	      var json = {};
	      for (var item in _btns.btns) {
	        !_btns.btns[item].action && (json[item] = 'default');
	      }
	      json[name] = 'actived';
	      this.$store.dispatch('updatePopupDisplay', {
	        name: name,
...
/***/ function(module, exports) {
	...
	exports.default = {
	  toolbar: ['removeFormat', 'undo', '|', 'format', 'fontName', 'fontSize', 'foreColor', 'backColor', 'divider', 'bold', 'italic', 'underline', 'strikeThrough', 'link', 'unLink', 'divider', 'subscript', 'superscript', 'divider', 'justifyLeft', 'justifyCenter', 'justifyRight', 'justifyFull', '|', 'indent', 'outdent', 'insertOrderedList', 'insertUnorderedList', '|', 'picture', 'table', '|', 'fullScreen', 'sourceCode', 'markdown'],
...
/***/ function(module, exports) {
	...
	var exec = exports.exec = function exec(_ref7, data) {
...
/***/ function(module, exports) {
	...
	exports.default = {
	  ...
	  UPDATE_BUTTON_STATES: function UPDATE_BUTTON_STATES(_ref3, data) {
	    ...
	    ['sourceCode', 'markdown', 'fullScreen'].forEach(function (item) {
	      toolbar[item] && (toolbar[item].status = 'default');
	    });
	  },
	  UPDATE_POPUP_DISPLAY: function UPDATE_POPUP_DISPLAY(_ref4, json) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (config) {
	  ...
	  var mutations = __webpack_require__(20);

	  var _require = __webpack_require__(2),
	      btns = _require.btns,
	      selects = _require.selects;
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"editor":"Az9ECxXf2bg0saab-HJuY_0"};
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"wrap":"_2T9WD2D47RUUwZfCP40fYJ_0"};
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"ctn":"_3K88AeqPM5bvUs73oXJS4i_0"};
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"ctn":"LgCpYevw8jVsOH4KQwNEX_0"};
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"ctn":"_3HTutBET6dLFMxCF-UBWGT_0"};
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"ctn":"BH5VIImEflZEIMp8CUs9a_0","input":"_2I3u1DXeoSlgjP3cgM98ux_0","btn":"pxqHdCdhgQ9rrysEhrJgk_0"};
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"ctn":"_2qQIGssouc5rC2EqnMDVyK_0"};
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"editor":"_31sjThh4deXX0g3ehqSZ2p_0","iframe":"_3ytmOLXduY0FY9-B7Npk6S_0"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* styles */
	__vue_styles__["$style"] = __webpack_require__(26)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_h('ul', [_vm._l((_vm.fonts), function(font) {
	    return _h('li', {
	      on: {
	        "click": function($event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_h('ul', [_vm._l((_vm.fontSize), function(size) {
	    return _h('li', {
	      on: {
	        "click": function($event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_vm._s(_vm.lang.ok)])]), " ", _h('ul', [_vm._l((_vm.colors), function(color) {
	    return _h('li', {
	      on: {
	        "click": function($event) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _h('div', {
	    ...
	    return [(item in _vm.btns) ? _h('a', {
	      ...
	      class: {
	        've-triangle-down': !_vm.display, 've-triangle-up': _vm.display
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_h('toolbar'), " ", _h('design'), " ", _vm._l((_vm.list), function(item) {
	    return [(_vm.config.toolbar.indexOf(item.replace('ve', '')) !== -1) ? _h(item, {
	      tag: "component"
	    }) : _vm._e()]
	  })])
	},staticRenderFns: []}
